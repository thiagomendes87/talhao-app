...
const perfilDescricoes: Record<string, string> = {
  'Produtor Rural': 'Acessa dados fundiários para gestão e regularização das próprias propriedades.',
  'Consultor Rural': 'Utiliza dados geoespaciais para assessorar clientes em análises e regularizações.',
  'Corretor / Imobiliária': 'Pesquisa imóveis rurais para transações, avaliações e due diligence.',
  'Investidor': 'Analisa propriedades e regiões para identificar oportunidades de investimento.',
  'Outro': 'Acessa dados fundiários conforme necessidade específica.',
}
        ...
        <section className="rounded-2xl border border-[rgba(28,43,24,0.08)] bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-8 grid gap-5">
            ...
            <div>
              ...
              {perfilDescricoes[perfil] && (
                <div className="mt-2 flex items-start gap-2 rounded-xl border border-[rgba(28,43,24,0.08)] bg-[#f4f7f5] px-3 py-2.5">
                  <svg className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#4f6347]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <p className="text-xs leading-relaxed text-[#4f6347]">{perfilDescricoes[perfil]}</p>
                </div>
              )}
            </div>
