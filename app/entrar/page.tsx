    ...
    <div className="min-h-screen grid grid-cols-2">
      ...
      <div className="flex flex-col justify-between p-12" style={{ background: 'linear-gradient(145deg, #1A1A2E 0%, #2D6A4F 100%)' }}>
        ...
        <div className="flex gap-8">
          {[['10M+', 'Polígonos CAR'], ['27', 'Estados cobertos'], ['100%', 'Dados SICAR']].map(([n, l]) => (
            <div key={l}>
      ...
      <div className="flex flex-col justify-center px-12 py-10 bg-white">
        ...
        <div className="flex items-center gap-3 my-1 text-xs text-gray-400">
          <div className="flex-1 h-px bg-gray-200" />ou entre com seu email<div className="flex-1 h-px bg-gray-200" />
        </div>
        ...
        <form className="mt-4 space-y-4">
          ...
          <div>
            ...
            <Link href="#" className="block text-right text-xs text-gray-400 mt-1.5 hover:text-gray-600">Esqueceu a senha?</Link>
          </div>
          <button type="submit" className="btn-primary w-full py-3 rounded-xl text-base font-bold mt-2">
            Entrar →
          </button>
        </form>
