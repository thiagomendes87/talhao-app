export default function WhatsAppTeaser() {
  return (
    <section className="py-12 px-10 bg-green-50 border-t border-green-100 grid grid-cols-2 gap-12 items-center" style={{ background: '#F0FDF4', borderColor: '#D1FAE5' }}>
      <div>
        <h2 className="text-2xl font-extrabold text-[#1A1A2E] mb-3">Em breve: busca pelo WhatsApp</h2>
      ...
      <div className="rounded-2xl overflow-hidden shadow-lg" style={{ background: '#ECE5DD' }}>
        <div className="px-4 py-3 flex items-center gap-3" style={{ background: '#075E54' }}>
          <div className="w-9 h-9 bg-[#40916C] rounded-full flex items-center justify-center text-base">🌿</div>
          <div>
        ...
        <div className="p-4 space-y-2">
          <div className="ml-auto max-w-[80%] bg-[#DCF8C6] rounded-lg rounded-tr-sm px-3 py-2 text-xs leading-relaxed">
            Oi! Preciso do CAR dessa fazenda aqui 📍 [-14.235, -51.925]
            <div className="text-gray-400 text-right text-[10px] mt-1">14:32 ✓✓</div>
          </div>
          <div className="mr-auto max-w-[80%] bg-white rounded-lg rounded-tl-sm px-3 py-2 text-xs leading-relaxed">
